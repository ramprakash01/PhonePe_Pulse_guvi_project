...
icon = Image.open(
    "C:\Users\Ram d\Downloads\ICN.png")
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By k d Ram prakash",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *k d Ram prakash*!
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/ramprakash01/PhonePe_Pulse_guvi_project")
